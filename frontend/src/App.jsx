...
import Usuarios from "./pages/Usuarios"; // <-- Importamos la nueva vista

export default function App() {
  const { user, logout } = useAuth();
  
  // Por defecto, si es trabajador (3) mandarlo a daily, si no, al dashboard
  const [activePage, setActivePage] = useState(user?.kpi_rol_id === 3 ? "daily" : "dashboard"); 
